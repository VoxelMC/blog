...
I know of labs which still use restriction-ligation using Type-II enzymes. It's
not terrible, and in fact, yields results. But it begs the question; why? Why is
it so hard to adopt new standards? Is synbio evolving too fast? If so, should we
put a pause on standardization and focus more on implementation?
...
[MoClo standard](https://www.addgene.org/cloning/moclo/) which itself is built
on the Golden Gate Cloning standard. This is the method which my iGEM teams used
in 2022 and 2023.
...
### Chassis engineering techniques
...
In terms of standardization of chassis engineering, <mark>there is no
precedent</mark>. For now...
